---
title: "Ban420 home exam, fall 2022, Candidate no. 77"
author: "Tomke Splettstoesser"
...
Input interest rate equation into demand side:

$$ \begin{aligned} 
  R_t &= m(\pi_t - \bar{\pi}) + \bar{r} \\
 y_t &= a_t - b(R_t - \bar{r}) \\
 \Leftrightarrow y_t &= a_t - b(m(\pi_t - \bar{\pi}) + \bar{r} - \bar{r})) \\
 \Leftrightarrow y_t &= a_t - b(m(\pi_t - \bar{\pi})) \\
\end{aligned}
$$
